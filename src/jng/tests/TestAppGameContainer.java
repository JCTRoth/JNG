...
public class TestAppGameContainer extends AppGameContainer {
	...
	public TestAppGameContainer(Game game, int width, int height,
	...
	/**
	 * uses the same step size of 23 as the usual AppGameContainer.
	 * 
	 * @param delta
	 * @throws SlickException
	 */
	public void updateGame(int delta) throws SlickException {
		...
		game.update(this, delta);
		game.update(this, 0);
		getTestInput().clearDownKeys();
		getTestInput().clearPressedKeys();
	}
